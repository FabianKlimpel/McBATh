...
# on the next line
CXXSRCS = WeightsHandler.cxx SDataHandler.cxx Batman.cxx ConfigHandler.cxx RefHandler.cxx Counter.cxx Power.cxx CovMatHandler.cxx BMprof.cxx BMSkynet.cxx PreTune.cxx
...
# compiler and flags
CXX       = g++
CXXFLAGS  = -pg -g -O2 -Wall -fPIC -Wno-deprecated 
